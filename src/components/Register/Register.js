...
class Register extends React.Component {
   ...
   onSubmitRegister = () => {
      fetch('https://polar-spire-59817.herokuapp.com/register', {
         method: 'post',
   ...
   render() {
      ...
      return (
       <article className="br4 ba b--black-10 mv4 w-100 w-50-m w-25-l mw7 shadow-4 center">
            ...
            <div className="measure">
               <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                  ...
                  <div className="mt3">
                     ...
                     <input className="pa2 input-reset ba bg-transparent hover-bg-white hover-black w-100" type="email" name="email-address"  id="name"
